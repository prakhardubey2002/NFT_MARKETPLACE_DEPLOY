...
const Create = () => {
	...
	const mintNow = (e) => {
		toast("Transaction Intialised wait while we connect")
		e.preventDefault();
		setStatus("Loading");
							...
							<table className="table">
								<tbody>
									...
									<tr>
										<td className="py-4 ps-2 w-50 text-start">
											Public Key<br />
											<small>Your wallet's public key (string)(Public Key will be auto detected if it appear blank enter manually from phantom )</small>
										</td>
										<td className="px-5 pt-4">
